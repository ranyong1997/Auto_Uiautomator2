...
from soloop.v128.element.element_router import ElementRouter
...
class VideoExportPage(BasePage):
    ...
    def click_music(self):
        ...
        for j in range(2):
            ...
            for i in range(2):
                ...
                i += 1
        self.find_element_and_click(**self.element["click_music"])
    ...
    def click_replace(self):
        self.find_element_and_drag(200, **self.element["speed"])
    ...
    def click_reverse(self):
        self.find_element_and_drag(200, **self.element["background"])
    ...
    def click_rotation(self):
        self.find_element_and_drag(200, **self.element["background"])
        self.sleep(1)
        self.find_element_and_drag(200, **self.element["replace"])
        i = 1
        while i < 5:
    ...
    def click_pip(self):
        ...
        self.find_element_and_drag(200, **self.element["hierarch_pip"])
